                ...
                <div className='bg-white p-5 w-full max-w-sm mx-auto shadow-lg rounded-lg'>
                    <form className='pt-6 flex flex-col gap-2' onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <div className='bg-blue-50 p-2 flex rounded'>
                                <input 
                            ...
                            <Link to={'/reset-password'} className='block w-fit ml-auto text-blue-600 hover:underline hover:text-blue-700 mt-1'>
                                Reset-Password?
                            </Link>
                        </div>

                        <button className='bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 w-full max-w-[150px] rounded-full hover:scale-105 transition-all mx-auto block mt-6'>
                            Login
                        </button>
                    </form>
