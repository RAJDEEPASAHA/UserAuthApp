...
const SignUp = () => {
    ...
    const [isOtpSent, setIsOtpSent] = useState(false); // To track whether OTP is sent
    ...
    const handleSubmit = async (e) => {
        ...
        if (data.password === data.confirmPassword) {
            ...
            if (dataApi.success) {
                ...
                setIsOtpSent(true); // OTP is sent, show OTP input
            } else {
        ...
        <div className="min-h-screen flex items-center justify-center bg-blue-50">
            <div className="bg-white p-6 rounded-md shadow-md w-full max-w-md">
                ...
                <p className="my-5">
                    ...
                    <Link to={"/login"} className="text-blue-600 hover:text-blue-400 hover:underline">
                        Login
                    </Link>
                </p>
            </div>
